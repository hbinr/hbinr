...
- 🌱 I’m currently learning :
  - [Harness engineering]
  - [Agent]
- 🔬 Projects I'm currently researching:
  - [OpenViking](https://github.com/volcengine/OpenViking) - Volcengine's open-source AI agent framework
...
- 🎼 My repositories that need to be focused on:
  ...
  - [kratos-admin](https://github.com/hbinr/kratos-admin) - Simple user-service application built with Kratos, GORM, go-redis and Zap
  - [XS-bbs](https://github.com/hbinr/XS-bbs) - BBS forum application developed after learning Go
